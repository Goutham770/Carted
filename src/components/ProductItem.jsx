  ...
  return (
    <div className="rounded-xl shadow-inner hover:shadow-2xl hover:shadow-gray-500 shadow-gray-300 hover:-rotate-2 hover:scale-105 transition  p-4 flex flex-col items-center  mb-8">
      ...
      <button
        ...
        className="bg-green-500 border-2 border-green-400 transition hover:border-green-300 hover:border-2 hover:bg-transparent hover:text-green-400  text-white font-bold py-2 px-4 rounded mt-auto"
      >
        Add to Cart
      </button>
    </div>
